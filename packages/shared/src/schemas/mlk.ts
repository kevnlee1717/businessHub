...
export const mlkCoupleBaseSchema = z.object({
  ...
  phone: nullableOptionalText,
  wechat: nullableOptionalText,
  ep_holder: z.enum(["husband", "wife"]).nullable().optional(),
  pr_status: z.enum(["none", "applied", "granted"]).default("none"),
  contract_signed_at: dateString.nullable().optional(),
  deposit_paid_at: dateString.nullable().optional(),
  deposit_amount: moneyNumber.nullable().optional(),
