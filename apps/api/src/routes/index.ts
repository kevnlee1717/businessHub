...
import { registerCaseServiceRoutes } from "./caseServices";
...
import { registerCourseDesignItemRoutes } from "./courseDesignItems";
...
import { registerIpadSlideRoutes } from "./ipadSlides";
...
import { registerStatementRoutes } from "./statement";
...
export async function registerRoutes(app: FastifyInstance): Promise<void> {
  ...
  await app.register(registerCaseServiceRoutes);
  ...
  await app.register(registerEpPackageRoutes);
  await app.register(registerEpPriceFileRoutes);
