...
function serializeCouple(row: CoupleRow) {
  return {
    ...
    phone: row.phone,
    wechat: row.wechat,
    ep_holder: row.epHolder,
    pr_status: row.prStatus,
    contract_signed_at: row.contractSignedAt,
    deposit_paid_at: row.depositPaidAt,
    deposit_amount: numberValue(row.depositAmount),
...
function coupleValues(body: MlkCoupleCreateInput | MlkCoupleUpdateInput) {
  return {
    ...
    ...(body.phone !== undefined ? { phone: body.phone } : {}),
    ...(body.wechat !== undefined ? { wechat: body.wechat } : {}),
    ...(body.ep_holder !== undefined ? { epHolder: body.ep_holder } : {}),
    ...(body.pr_status !== undefined ? { prStatus: body.pr_status } : {}),
    ...(body.contract_signed_at !== undefined ? { contractSignedAt: body.contract_signed_at } : {}),
    ...(body.deposit_paid_at !== undefined ? { depositPaidAt: body.deposit_paid_at } : {}),
    ...(body.deposit_amount !== undefined ? { depositAmount: body.deposit_amount === null ? null : numericValue(body.deposit_amount) } : {}),
